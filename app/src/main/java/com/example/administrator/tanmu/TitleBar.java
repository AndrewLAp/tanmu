...
public class TitleBar extends RelativeLayout {
    ...
    private void setTitleBarLayoutParams() {
        ...
        btnLeftLayoutParams.addRule(RelativeLayout.CENTER_VERTICAL,TRUE);
        ...
        btnRightLayoutParams.addRule(RelativeLayout.CENTER_VERTICAL,TRUE);
    ...
    private void findAttrs(AttributeSet attrs) {
        ...
        leftTextSize = typedArray.getDimension(R.styleable.TitleBar_leftTextSize, 15);
        ...
        titleTextSize = typedArray.getDimension(R.styleable.TitleBar_titleTextSize, 15);
        ...
        rightTextSize = typedArray.getDimension(R.styleable.TitleBar_rightTextSize, 15);
    ...
    public void setBtnRightText(String rightText){
        btnRight.setText(rightText);
    }
